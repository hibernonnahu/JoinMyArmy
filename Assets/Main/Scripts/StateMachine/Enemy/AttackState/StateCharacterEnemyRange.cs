...
public class StateCharacterEnemyRange : StateCharacterEnemy
{
    ...
    private bool shot;
    public StateCharacterEnemyRange(StateMachine<StateCharacterEnemy> stateMachine, CharacterEnemy characterEnemy, BulletPool bulletPool, GameObject[] toHide, float bulletSpeed) : base(stateMachine, characterEnemy)
    {
